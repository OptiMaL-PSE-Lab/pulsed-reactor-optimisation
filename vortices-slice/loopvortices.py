...
pLUT.RGBPoints = [-0.34813499450683594, 0.231373, 0.298039, 0.752941, -0.17406749725341797, 0.865003, 0.865003, 0.865003, 0.0, 0.705882, 0.0156863, 0.14902]
pLUT.UseLogScale = 0
...
aafoamDisplay.ScaleTransferFunction.Points = [-0.34813499450683594, 0.0, 0.5, 0.0, 0.0, 1.0, 0.5, 0.0]
aafoamDisplay.ScaleTransferFunction.UseLogScale = 0

# init the 'PiecewiseFunction' selected for 'OpacityTransferFunction'
aafoamDisplay.OpacityTransferFunction.Points = [-0.34813499450683594, 0.0, 0.5, 0.0, 0.0, 1.0, 0.5, 0.0]
...
# init the 'PiecewiseFunction' selected for 'ScaleTransferFunction'
slice1Display.ScaleTransferFunction.Points = [-0.30105113983154297, 0.0, 0.5, 0.0, -0.0472472608089447, 1.0, 0.5, 0.0]
slice1Display.ScaleTransferFunction.UseLogScale = 0

# init the 'PiecewiseFunction' selected for 'OpacityTransferFunction'
slice1Display.OpacityTransferFunction.Points = [-0.30105113983154297, 0.0, 0.5, 0.0, -0.0472472608089447, 1.0, 0.5, 0.0]
...
sLUT.RGBPoints = [-8.445689445579774e-07, 0.231373, 0.298039, 0.752941, 0.2274766811872837, 0.865003, 0.865003, 0.865003, 0.45495420694351196, 0.705882, 0.0156863, 0.14902]
sLUT.UseLogScale = 0
...
sPWF.Points = [-8.445689445579774e-07, 0.0, 0.5, 0.0, 0.45495420694351196, 1.0, 0.5, 0.0]
...
# init the 'PiecewiseFunction' selected for 'OSPRayScaleFunction'
surfaceVectors1Display.OSPRayScaleFunction.Points = [0.0, 0.0, 0.5, 0.0, 1.0, 1.0, 0.5, 0.0]
...
# init the 'PiecewiseFunction' selected for 'ScaleTransferFunction'
surfaceVectors1Display.ScaleTransferFunction.Points = [-0.30084919929504395, 0.0, 0.5, 0.0, -0.0472160279750824, 1.0, 0.5, 0.0]
surfaceVectors1Display.ScaleTransferFunction.UseLogScale = 0

# init the 'PiecewiseFunction' selected for 'OpacityTransferFunction'
surfaceVectors1Display.OpacityTransferFunction.Points = [-0.30084919929504395, 0.0, 0.5, 0.0, -0.0472160279750824, 1.0, 0.5, 0.0]
...
vorticityFieldLUT.RGBPoints = [0.3821501140585807, 0.231373, 0.298039, 0.752941, 218.89495103418685, 0.865003, 0.865003, 0.865003, 437.4077519543151, 0.705882, 0.0156863, 0.14902]
...
vorticityFieldPWF.Points = [0.3821501140585807, 0.0, 0.5, 0.0, 437.4077519543151, 1.0, 0.5, 0.0]
...
# init the 'PiecewiseFunction' selected for 'ScaleTransferFunction'
maskPoints1Display.ScaleTransferFunction.Points = [-0.3008255064487457, 0.0, 0.5, 0.0, -0.04750198870897293, 1.0, 0.5, 0.0]
maskPoints1Display.ScaleTransferFunction.UseLogScale = 0

# init the 'PiecewiseFunction' selected for 'OpacityTransferFunction'
maskPoints1Display.OpacityTransferFunction.Points = [-0.3008255064487457, 0.0, 0.5, 0.0, -0.04750198870897293, 1.0, 0.5, 0.0]
...
# init the 'PiecewiseFunction' selected for 'OSPRayScaleFunction'
streamTracerWithCustomSource1Display.OSPRayScaleFunction.Points = [0.0, 0.0, 0.5, 0.0, 1.0, 1.0, 0.5, 0.0]
...
# init the 'PiecewiseFunction' selected for 'ScaleTransferFunction'
streamTracerWithCustomSource1Display.ScaleTransferFunction.Points = [-0.3008274734020233, 0.0, 0.5, 0.0, -0.047243405133485794, 1.0, 0.5, 0.0]
streamTracerWithCustomSource1Display.ScaleTransferFunction.UseLogScale = 0

# init the 'PiecewiseFunction' selected for 'OpacityTransferFunction'
streamTracerWithCustomSource1Display.OpacityTransferFunction.Points = [-0.3008274734020233, 0.0, 0.5, 0.0, -0.047243405133485794, 1.0, 0.5, 0.0]
...
streamTracerWithCustomSource1Display.DataAxesGrid.CustomBounds = [0.0, 1.0, 0.0, 1.0, 0.0, 1.0]
...
streamTracerWithCustomSource1Display.PolarAxes.CustomBounds = [0.0, 1.0, 0.0, 1.0, 0.0, 1.0]
...
streamTracerWithCustomSource1Display.PolarAxes.SecondaryRadialAxesColor = [1.0, 1.0, 1.0]
...
streamTracerWithCustomSource1Display.PolarAxes.SecondaryRadialAxesTextFontFamily = 'Arial'
...
# change solid color
streamTracerWithCustomSource1Display.AmbientColor = [0.7137254901960784, 0.7137254901960784, 0.7137254901960784]
streamTracerWithCustomSource1Display.DiffuseColor = [0.7137254901960784, 0.7137254901960784, 0.7137254901960784]
...
renderView1.CameraPosition = [-0.04555426634505638, 0.0034725007420105284, 0.004980766728780848]
renderView1.CameraFocalPoint = [-0.00410274657454531, 0.010955481532701906, 0.004939271456374059]
renderView1.CameraViewUp = [0.0, 0.0, 1.0]
renderView1.CameraViewAngle = 6.952789699570816
renderView1.CameraParallelScale = 0.016769382003033996

# save screenshot
SaveScreenshot('test-%.3f.png' %tt, renderView1, ImageResolution=[1165, 801],
