...
try:
    ...
    data_path = 'parameterisation_study/both/data.json'
    gamma = 2.5 
    beta = 1.5 
    p_c = 2
    cpus = 1
...
mfbo(eval_cfd, data_path, x_bounds, z_bounds,120*60*60,gamma=gamma, beta=beta, p_c=p_c,gp_ms=4,opt_ms=8,sample_initial=32,int_fidelities=[True,True])
