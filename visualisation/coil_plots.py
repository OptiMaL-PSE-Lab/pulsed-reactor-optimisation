...
def demo_inversion(x: dict, length: float, tube_rad: float):
    ...
    plt.tight_layout()
    plt.savefig("visualisation/inversion_demo.png", dpi=800)
    return


def demo_pitch(x: dict, length: float, tube_rad: float):
    ...
    plt.tight_layout()
    plt.savefig("visualisation/pitch_demo.png", dpi=800)
    return


def demo_radius(x: dict, length: float, tube_rad: float):
    ...
    plt.tight_layout()
    plt.savefig("visualisation/radius_demo.png", dpi=800)
    return
...
demo_pitch({'inversion_loc':0.001,'coil_rad':0.0075,'fid_radial':40,'fid_axial':1},0.0753,0.0025)
demo_inversion({'pitch':0.01,'coil_rad':0.0075,'fid_radial':40,'fid_axial':1},0.0753,0.0025)
