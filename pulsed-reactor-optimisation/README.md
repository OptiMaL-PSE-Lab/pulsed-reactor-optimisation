...
# Pulsed Reactor Optimisation - Manual

[![Code style: black](https://img.shields.io/badge/code%20style-black-000000.svg)](https://github.com/psf/black) [![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT) 

This repository contains code to optimise the geometric parameters and operating conditions of a computational fluid dynamics model of a pulsed flow helical tube reactor. As the CFD model is computationally expensive to evaluate, this is done through Bayesian optimisation.
This project assumes manual input of CFD input and output variables.
